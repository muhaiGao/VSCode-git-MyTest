			...
			10(g) = 0.0220462(lb),0.1(lb) = 45.359237(g)
			 ...
			 eg:
			 	...
			 	计算:weigh*10000/45359=55*10000/45359
			 		取整数位等于12，代表1.2(lb)
		*/
		weigh = weigh/10;//unit:100g
		//gu16_display_weight = (((u32)weigh*22046/1000)+15)/10/2*2;//display:x.0/x.2/x.4/x.6/x.8; Do not show:x.1/x.3/x.5/x.7
		gu16_display_weight = ((u32)weigh*(u32)2204/100+5)/10/2*2;

		/*
		 106.68LB时，就要显示106.8LB,如果有一个值算的是106.64，那LED显示106.6LB
		*/
	}
}
#endif
